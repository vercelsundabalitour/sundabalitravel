            ...
            <div className="p-4 border-b border-gray-200 sticky top-0 bg-white z-10">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-gray-100 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary text-gray-900"
                />
              </div>
            </div>
              ...
              {filteredLanguages.length === 0 ? (
                ...
                filteredLanguages.map((lang) => (
                  <button
                    ...
                    className="w-full px-4 py-3 flex items-center gap-3 hover:bg-gray-100 transition-colors text-left group"
                  >
